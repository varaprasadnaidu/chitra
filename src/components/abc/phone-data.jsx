                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                ...
                                onClick={() => this.handleCheck(this.props.prodata)}> View Bill</button> */}
                                   ...
                                   <button type="button" style={styles.btn1} className="btn btn-primary  col-8 mb-1 col-md-3">
                                 <Link className="text-white" to={`/billdetails/${this.props.prodata.id}`}>View bill</Link></button>
                                <button type="button" style={styles.btn1} className="btn btn-primary col-8 mb-1 col-md-3"> View Plan</button>
                                <button type="button" style={styles.btn1} className="btn btn-primary col-8 col-md-3"> Support</button>
                            </div>
                        </div>
